...
class HelpPage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        self.label.grid(row=0, column=0, pady=10, padx=10, sticky="se", wraplength=15)
        self.label2.grid(row=1, column=0, pady=10, padx=10, sticky="se", wraplength=15)
        self.label3.grid(row=2, column=0, pady=10, padx=10, sticky="se", wraplength=15)
        self.label4.grid(row=3, column=0, pady=10, padx=10, sticky="se", wraplength=15)
        self.label5.grid(row=4, column=0, pady=10, padx=10, sticky="se", wraplength=15)
        self.label6.grid(row=5, column=0, pady=10, padx=10, sticky="se", wraplength=15)
        self.label7.grid(row=6, column=0, pady=10, padx=10, sticky="se", wraplength=15)
        self.label8.grid(row=7, column=0, pady=10, padx=10, sticky="se", wraplength=15)
